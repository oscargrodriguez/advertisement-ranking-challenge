...
public class AdsControllerTest {
    ...
    void irrelevantAds() throws Exception {
        mockMvc.perform(get("/ads/irrelevant"))
                ...
                .andExpect(jsonPath("$[0].typology").value("CHALET"))
                .andExpect(jsonPath("$[0].description").isNotEmpty())
                .andExpect(jsonPath("$[0].pictureUrls", hasSize(0)))
                .andExpect(jsonPath("$[0].houseSize").value("300"))
                .andExpect(jsonPath("$[0].gardenSize").isEmpty())
                .andExpect(jsonPath("$[0].irrelevantSince").isNotEmpty())
